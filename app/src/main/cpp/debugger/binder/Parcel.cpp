...
Parcel::Parcel(const unsigned char *parcel_data, size_t data_size, const unsigned char *offsets, size_t offsets_size)
    : parcel_data_(parcel_data), data_size_(data_size), offsets_(offsets), offsets_size_(offsets_size), offset_(0) {}
